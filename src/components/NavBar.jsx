    ...
    <div className="w-screen m-0 p-0 shadow-md">
      <div className="navbar bg-gradient-to-r from-blue-600 to-purple-600 shadow-lg w-full fixed top-0 left-0 z-50 px-4 md:px-8 py-2">
        <div className="flex-1">
          <Link to="/" className="btn btn-ghost text-2xl font-bold text-white hover:text-yellow-300 transition-colors">
            🫶 Dev Tinder
          </Link>
        </div>
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          {user && (
            <div className="dropdown dropdown-end relative">
              ...
              >
                <li>
                  <Link to="/profile" className="justify-between hover:bg-purple-100 transition-colors rounded-md">
                ...
                <li>
                  <a onClick={handleLogout} className="hover:bg-purple-100 transition-colors rounded-md">Logout</a>
                </li>
              </ul>
            </div>
          )}
